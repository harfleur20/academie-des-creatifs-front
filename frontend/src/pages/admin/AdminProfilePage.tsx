      ...
      <div className="sprof-grid">
        <aside className="sprof-aside">
          <div className="sprof-card sprof-avatar-card">
            ...
            <span className="sprof-avatar-role">Administrateur</span>
          ...
          <div className="sprof-card sprof-info-card">
            ...
            <div className="sprof-info-row">
              ...
              <span className="sprof-info-row__value">Administrateur</span>
            </div>
            <div className="sprof-info-row">
            ...
            <form className="sprof-form" onSubmit={handleInfoSubmit}>
              <div className="sprof-field">
                ...
                <div className="sprof-input-wrap">
                  ...
                  <input type="text" className="sprof-input" value={infoName} onChange={(e) => setInfoName(e.target.value)} required placeholder="Votre nom complet" />
                </div>
              </div>
              <div className="sprof-field">
              ...
              <div className="sprof-field">
                ...
                <div className="sprof-input-wrap">
                  ...
                  <input type="tel" className="sprof-input" value={infoPhone} onChange={(e) => setInfoPhone(e.target.value)} placeholder="+33 6 00 00 00 00" />
                </div>
              </div>
            ...
            <form className="sprof-form" onSubmit={handlePasswordSubmit}>
              <div className="sprof-field">
                ...
                <div className="sprof-input-wrap">
                  ...
                  <input type={showCurrent ? "text" : "password"} className="sprof-input" value={pwCurrent} onChange={(e) => setPwCurrent(e.target.value)} required placeholder="••••••••" />
              ...
              <div className="sprof-field">
                ...
                <div className="sprof-input-wrap">
                  <Lock size={15} className="sprof-input-icon" />
                  <input type={showNew ? "text" : "password"} className="sprof-input" value={pwNew} onChange={(e) => setPwNew(e.target.value)} required placeholder="Minimum 8 caractères" />
              ...
              <div className="sprof-field">
                ...
                <div className="sprof-input-wrap">
                  <Lock size={15} className="sprof-input-icon" />
                  <input type="password" className="sprof-input" value={pwConfirm} onChange={(e) => setPwConfirm(e.target.value)} required placeholder="••••••••" />
                  {pwConfirm && (
